...
const PokemonDetail = () => {
  ...
  } else if (createItemId) {
    content = (
      <ItemForm
        pokemonId={pokemonId}
        formType={'Create Item'}
        hideForm={() => setCreateItemId(null)}
      />
    );
      ...
      <div className="pokemon-detail-lists">
        ...
        <div>
          <h2>
            ...
            {
              pokemon.captured &&
              <button onClick={() => setCreateItemId(true)}> + </button>
            }
          </h2>
          <table>
            <thead>
            ...
            <tbody>
              <PokemonItems value={deleteItemId} pokemon={pokemon} setEditItemId={setEditItemId} setDeleteItemId={setDeleteItemId} />
            </tbody>
          </table>
        </div>
      </div>
